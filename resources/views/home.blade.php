...
@section('content')
    <div class="container">
        ...
        <div class="jumbotron">
            <h2>分享就是财富!
                <a class="btn btn-lg btn-primary pull-right" href="{{ url('/posts/create') }}" role="button">去分享 »</a>
                    ...
                    @foreach($row as $discussion)
                        <div class="media">
                            <div class="media-left">
                                <a href="{{ url('posts',$discussion->id) }}">
                                    <img class="media-object img-circle" with="64" height="64" src="{{ $discussion->user->avatar }}" alt="64*64">
                                </a>
                            </div>
                            <div class="media-body">

                                <h4 class="media-heading"><a href="{{ url('posts',$discussion->id) }}">{{ $discussion->title }}</a>
